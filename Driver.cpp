...
int main()
{
    ...
    expenseManager.addUser(User("u1", "User1", "abc@gmail.com", "1"));//Dummy values provided
    expenseManager.addUser(User("u2", "User2", "def@gmail.com", "2"));
    expenseManager.addUser(User("u3", "User3", "ghi@gmail.com", "3"));
    expenseManager.addUser(User("u4", "User4", "xyz@gmail.com", "4"));
    while(true)
    {
        string inputLine;
